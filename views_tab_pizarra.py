...
from formulas_lib_funciones import calcular_edad_tecnica_al_31_dic, calcular_categoria_competencia  #[cite: 1]
def renderizar_tab_pizarra(datos_sidebar):
    ...
    with subtab_crear:  #[cite: 1]
        ...
        if st.session_state.pizarra_entrenamiento:  #[cite: 1]
            ...
            st.caption("Genera el formato de comunicación para enviar a los atletas por canales digitales o preparar la hoja impresa.")  #[cite: 1]
            ...
            if tipo_filtro == "Atletas Específicos" and not atletas_finales:  #[cite: 1]
                ...
                st.success(f"🎯 Grupo confirmed para imputación: {len(atletas_finales)} atleta(s).")  #[cite: 1]
                                ...
                                with c_act1:  #[cite: 1]
                                    ...
                                    if st.button(label_boton, key=f"btn_tpl_{fecha_sesion}_{carril_sesion}", type=color_tipo, use_container_width=True):  #[cite: 1]
                                        ...
                                        if pizarra_guardada and isinstance(pizarra_guardada, list) and len(pizarra_guardada) > 0:
                                            ...
                                            st.session_state.pizarra_entrenamiento = bloques_reconstructed  #[cite: 1]
