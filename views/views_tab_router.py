...
with tab_marcas:
    render_tab_marcas(
        ...
        titulo_grafico="Control de Marcas", es_preinfantil=False, convertir_string_a_segundos=convertir_string_a_segundos, calcular_edad_decimal=calcular_edad_decimal, formatear_a_minutos=formatear_a_minutos, calcular_categoria_competencia=calcular_categoria_competencia)
        with tab_entrenador:
